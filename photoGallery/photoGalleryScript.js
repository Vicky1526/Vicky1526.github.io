...
//top part
var imagesData = [{
        photo: "/photoGallery/img/madartavlat-tajkep-termeszet-kreativ.jpg",
    ...
    {
        photo: "/photoGallery/img/eg-erdo-fak-fenseges.jpg",
    ...
    {
        photo: "/photoGallery/img/eg-erdo-fak-fenyvisszaverodes.jpg",
    ...
    {
        photo: "/photoGallery/img/erdo-fak-kod-kodos.jpg",
    ...
    {
        photo: "/photoGallery/img/csobbanas-folyam-h2o-hullam.jpg",
    ...
    {
        photo: "/photoGallery/img/tajkep-hegyek-termeszet-eg.jpg",
...
//single box calling
/* $('#imgBig').attr('src', imagesData[0].photo.photo);
$('#photoTitle').text(imagesData[0].photo.title);
$('#photoDescription').text(imagesData[0].photo.description); */
...
imagesData.forEach((item, index) => {
    ...
    $('.imageHolder').click((e) => {
        ...
        $('#imgBig').attr('src', imagesData[indexClicked].photo);
...
var imageHolderClicked = document.querySelectorAll(".imageHolder")
imageHolderClicked[0].classList.add("selected")
for (var i = 0; i < imageHolderClicked.length; i++) {
    imageHolderClicked[i].addEventListener("click", function() {
        imageHolderClicked[0].classList.remove("selected")
        imageHolderClicked[1].classList.remove("selected")
        imageHolderClicked[2].classList.remove("selected")
        imageHolderClicked[3].classList.remove("selected")
        imageHolderClicked[4].classList.remove("selected")
        imageHolderClicked[5].classList.remove("selected")
